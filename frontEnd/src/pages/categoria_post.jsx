        ...
        <div className="container posts_container">
            <article className="post">
                ...
                <div className="post_info">
                    <a to="categoria_post.html" className="categoria_button">vida salvaje</a>
                    <h3 className="post_titulo"><a to="post.html">Lorem ipsum dolor sit, amet 
                        consectetur adipisicing elit. Ab?</a>
                    </h3>
...
export default caategoria_post
